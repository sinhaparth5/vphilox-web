...
<h2 class="abstract-head">Abstract</h2>

<div class="abstract">

A long simulation that checkpoints its random generator and resumes on a
different machine is relying on a property that `std::mt19937` does not
...
$0.22\times$ and $0.75\times$ the cost per byte of `std::mt19937` on the
